  ...
  if (ltvCompCtx) {
    try {
      new Chart(ltvCompCtx, {
        type: 'bar',
        data: { labels: ['D90', 'D180', 'D365'], datasets: [{ label: 'LTV ($)', data: [parseFloat(results.ltv90), parseFloat(results.ltv180), parseFloat(results.ltv365)], backgroundColor: ['#667eea', '#764ba2', '#f093fb'] }] },
